...
async function main() {
  const outcome = process.env.INPUT_OUTCOME || "Tests de Cypress finalizado"; //Obtiene el valor de la variable de entorno INPUT_OUTCOME. Si no está definida, usa "success" como valor predeterminado.
  
  console.log(`Valor de Outcome: ${outcome}`);

  let badge;
  if (outcome === "Tests de Cypress finalizado") {
